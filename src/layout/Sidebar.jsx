...
const Navbar = () => {
  ...
  return (
    ...
    <div className="fixed md:block  hidden">
      <div className="pl-5 w-64 border-r-2 py-10 z-[999999] relative h-screen text-white bg-[#0B245B]">
        <div className="mb-10 text-sm">
          Welcome, <br /> <span className="font-semibold">Admin</span>
        </div>
        <div>
          ...
          <button
            onClick={logout}
            className=" absolute bottom-16 flex gap-3 text-base font-semibold items-center"
          >
